	...
	return (
		<>
			...
			<div className="m-2 flex flex-col w-[50%]">
				<a href='https://www.github.com/luccasandrade' target='_blank'>
					<div className="card w-40 flex flex-col items-center shadow-lg p-4 self-center border-0 rounded-md">
